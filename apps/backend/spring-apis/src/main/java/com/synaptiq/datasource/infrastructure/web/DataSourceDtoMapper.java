...
public interface DataSourceDtoMapper {
    ...
    default DataSourceType mapDsType(com.synaptiq.datasource.domain.model.DataSourceType type) {
        return type == null ? null : DataSourceType.fromValue(type.name());
    }

    @org.mapstruct.Named("mapDsStatus")
    default DataSourceStatus mapDsStatus(com.synaptiq.datasource.domain.model.DataSourceStatus status) {
