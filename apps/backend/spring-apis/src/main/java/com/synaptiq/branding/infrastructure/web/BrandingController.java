package com.synaptiq.branding.infrastructure.web;
...
import com.synaptiq.branding.application.port.in.ContrastCheckUseCase;
import com.synaptiq.infrastructure.in.web.api.BrandingApi;
import com.synaptiq.infrastructure.in.web.dto.*;
import com.synaptiq.shared.infrastructure.web.AppIdResolver;
...
public class BrandingController implements BrandingApi {
    ...
    public Mono<ResponseEntity<BrandingResponse>> updateBranding(Mono<BrandingResponse> body, String xTenantID, ServerWebExchange exchange) {
        return appIdResolver.resolve(exchange, xTenantID).flatMap(appId ->
            body.flatMap(b -> {
                var branding = com.synaptiq.application.domain.model.Application.Branding.builder()
    ...
    public Mono<ResponseEntity<PersonalizationResponse>> updatePersonalization(Mono<PersonalizationResponse> body, String xTenantID, ServerWebExchange exchange) {
        return appIdResolver.resolve(exchange, xTenantID).flatMap(appId ->
            body.flatMap(b -> {
                var personalization = com.synaptiq.application.domain.model.Application.Personalization.builder()
    ...
    private BrandingResponse toBrandingDto(com.synaptiq.application.domain.model.Application.Branding b) {
    ...
    private PersonalizationResponse toPersonalizationDto(com.synaptiq.application.domain.model.Application.Personalization p) {
