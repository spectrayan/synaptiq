package com.synaptiq.tenant.infrastructure.persistence.mongo.repository;

import com.synaptiq.tenant.application.port.out.TenantPersistencePort;
import com.synaptiq.tenant.domain.model.Tenant;
import com.synaptiq.tenant.infrastructure.persistence.mongo.mapper.TenantPersistenceMapper;
