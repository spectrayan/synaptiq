...
import com.spectrayan.synaptiq.infrastructure.in.web.api.TenantsApi;
import com.spectrayan.synaptiq.infrastructure.in.web.dto.*;
import com.spectrayan.synaptiq.tenant.application.port.in.CreateTenantUseCase;
    ...
    public Mono<ResponseEntity<TenantResponse>> createTenant(
        ...
        return req.flatMap(r -> createTenantUseCase.createTenant(
                new CreateTenantUseCase.CreateTenantCommand(
                    r.getTenantId(), r.getName(), r.getSlug(), r.getDisplayLabel(),
