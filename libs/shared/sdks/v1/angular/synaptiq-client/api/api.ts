...
export const APIS = [ActionsService, AnalyticsService, ApplicationsService, AuthService, BrandingService, ChatService, ConfigService, DataSourcesService, HealthService, IntegrationsService, NotificationsService, RolesService, SchemaRegistryService, TenantsService, WorkflowsService];
