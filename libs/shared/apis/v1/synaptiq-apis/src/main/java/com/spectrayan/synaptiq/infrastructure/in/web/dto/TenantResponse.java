...
public class TenantResponse {
  ...
  public TenantResponse displayLabel(@Nullable String displayLabel) {
  ...
  @Schema(name = "displayLabel", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("displayLabel")
  public @Nullable String getDisplayLabel() {
    return displayLabel;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, tenantResponse.tenantId) &&
        ...
        Objects.equals(this.displayLabel, tenantResponse.displayLabel) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, name, slug, status, accessMode, displayLabel, createdAt, updatedAt);
  }
