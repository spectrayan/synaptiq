...
public class ChatMessageRequest {
  ...
  @Schema(name = "sessionId", description = "The session to post the message to", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   * @return message
   */
  @NotNull @Size(min = 1, max = 32000) 
  @Schema(name = "message", description = "The user's message (capped at 32K chars to prevent LLM cost spikes)", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @Size(max = 100) 
  @Schema(name = "modelOverride", description = "Optional model override (e.g. gemini-2.5-flash)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
